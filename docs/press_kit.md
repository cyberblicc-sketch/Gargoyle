...
## Product Overview
**Gargoyle** is an AI‑powered shadow consultant that uncovers hidden opportunities and risks in legal and strategic domains.  It uses a multi‑agent system—comprised of a **Jurist**, **Cartographer** and **Strategist**—to analyse statutes, map patents and run simulations.  Unlike traditional legal research tools, Gargoyle synthesizes insights automatically and delivers creative strategies at half the cost.

## Taglines & Boilerplate
- **Tagline:** *Master the Maze.*
- **Short boilerplate:** Gargoyle is a multi‑agent AI platform that deconstructs complex legal and strategic challenges.  It reads laws, maps technologies and simulates outcomes, giving businesses a stealthy advantage.
...
## Visual Assets
- **Logo**: Provided in `gargoyle_app/logo.png` (512×512 PNG).  Dark silhouette of a gargoyle with futuristic accents.
- **Hero Image**: Provided in `gargoyle_app/hero-bg.jpg` – a dark city skyline with purple and blue gradients.

## Contact & Media Inquiries
Email: info@gargoyle.ai  
Twitter: @GargoyleAI  
LinkedIn: /company/gargoyle-ai  

For partnerships, demos or press interviews, please contact our media relations team at media@gargoyle.ai.
